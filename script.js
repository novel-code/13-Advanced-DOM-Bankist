...
// });
// lec 194 A Better Way: The Intersection Observer API
...
*/
// tabs.forEach(t => t.addEventListener('click', () => console.log('tab'))); (bad practice makes page slow)
